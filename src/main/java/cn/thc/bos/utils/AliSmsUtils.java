...
public class AliSmsUtils {
    ...
    static final String accessKeyId = "LTAIYSQ8zYXMRJhV";
    static final String accessKeySecret = "ErqIAE1OyFFjDqjzOe87NszKVZ3305";
    ...
    public static SendSmsResponse sendSms(String telephone,String username, String randomCode) throws ClientException {
        ...
        //必填:短信签名-可在短信控制台中找到
        request.setSignName("速运快递物流");     //云通信
        //必填:短信模板-可在短信控制台中找到
        request.setTemplateCode("SMS_135265124"); //    SMS_74285007
        //可选:模板中的变量替换JSON串,如模板内容为"亲爱的${name},您的验证码为${code}"时,此处的值为
        // 拼接的json串
        String templateJson1 = "{\"code\":\""+randomCode+"\"}";
        
        String templateJson2 ="{\"name\":\""+username+"\", \"code\":\""+randomCode+"\"}";
        
       // String other = "老婆";
        
        request.setTemplateParam(templateJson2); //{\"name\":\"许明\", \"code\":\"123\"}
